...
import { flights as flightsDefault } from "@/components/utils/config.globe";
...
class World {
  ...
  constructor(
    ...
    // Remove this line - the controls will be updated by the loop system
    ...
    if (container) {
      ...
      console.error("Container element is null. Cannot append the renderer's DOM element.");
    }
  }
